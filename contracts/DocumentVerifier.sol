...
contract DocumentVerifier {
    ...
    event DocumentUploaded(string fileHash, address indexed owner, uint256 timestamp);
    event DocumentVerified(string fileHash, bool isValid, address indexed verifier);
     ...
     */
    function verifyDocument(string memory fileHash) public returns (bool isValid) {
     ...
     */
    function getDocumentDetails(string memory fileHash)
        public
        view
